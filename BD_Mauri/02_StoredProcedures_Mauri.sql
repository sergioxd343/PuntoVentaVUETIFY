...
IF OBJECT_ID('InsertarEvaluacionResultado', 'P') IS NOT NULL
    DROP PROCEDURE InsertarEvaluacionResultado
GO
...
IF OBJECT_ID('InsertarSolicitudProyecto', 'P') IS NOT NULL
    DROP PROCEDURE InsertarSolicitudProyecto
GO
...
BEGIN
	...
	INSERT INTO asesoria (cve_empleado, materia, fecha, motivo_solicitud, sugerencias, entrevista, activo, fecha_registro)
	VALUES (@cve_empleado, @materia, @fecha, @motivo_solicitud, @sugerencias, @entrevista, @activo, @fecha_registro)
END
GO

IF OBJECT_ID('InsertarRubricaObservacionClase', 'P') IS NOT NULL
    DROP PROCEDURE InsertarRubricaObservacionClase
GO
...
IF OBJECT_ID('InsertarAnalisisDocente', 'P') IS NOT NULL
    DROP PROCEDURE InsertarAnalisisDocente
GO
