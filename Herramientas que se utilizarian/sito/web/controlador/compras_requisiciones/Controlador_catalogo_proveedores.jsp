...
<%
    ...
    String xml= String.valueOf(request.getRealPath(""))+"\\model\\compras_requisiciones\\CatalogoProveedores.xml";
    ...
    switch (accion) {
        case 1:
            out.println(datos.Consultas(parametros, "tablaProveedores"));
            break;
        case 2:
