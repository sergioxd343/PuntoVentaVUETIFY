                        ...
                        <v-container fluid>
                                ...
                                <v-col md=3>
                                    <v-select 
                                        ...
                                        v-validate="'required'"
                                        :items="arrayTiposProveedores"
                                        item-value="cve_tipoActividad"
                                        item-text="tipoActividad"
                                    ...
                                    >
                                        ...
                                        <template v-slot:item.editar="{item}">
                                            <v-btn fab small color="warning" @click="flagEditar = true; itemEditar = item;
                                                tipo = item.cve_tipo;
                                                nombreUsuario = item.nombre_corto;
                                                fecha = item.nombre;
                                                rfc = item.rfc;
                                                padron = item.clave_patron;
                                                nombrePerfil = item.nombre_contacto;
                                                correoContacto = item.correo;
                                                telefonoContacto = item.telefono;
                                                estatus = item.tipo_persona
        ...
        new Vue({
            ...
            setup(){
                ...
                return{
                    ...
                    nombreEvento, sesiones, horas, horario,nombreInstructor, lugar, tipoActividad, nombreAsistente, tipo, nombreUsuario, fecha, rfc, padron, nombrePerfil, correoContacto, telefonoContacto,estatus,
