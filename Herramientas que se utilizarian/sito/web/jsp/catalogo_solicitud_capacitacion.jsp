                ...
                <v-container fluid>
                    <v-card>
                        <v-card-title  style="background-color: #00b293; color:#ffffff; headline" >		
                            Solicitud de Registro de Capacitación Interna
                        </v-card-title>
                        <v-container fluid>
                            <v-row justify="center" class="align-center" style="padding: 0px 50px 0px 50px">
                                ...
                                <v-col md=12 style="text-align: center; background-color: #00b293; color: floralwhite;">
                                    <v-toolbar-title>Datos del Curso</v-toolbar-title>
                                </v-col>
                                ...
                                <v-col md=6>
                                    <v-subheader>Fecha del curso</v-subheader>
                                    <v-date-picker
                                        v-model="fecha"
                                        landscape
                                        class="mt-3"
                                ...
                                <v-col md=6>
                                    <v-textarea
                                        ...
                                        outlined
                                        label="Metodología"
                                        hint="Indicar si es un curso, foro, taller, etc., describir las características que tendrán las actividades a desarrolla"
                                        persistent-hint
                                        v-validate="'required|max:200'"
                                        data-vv-name="nombre corto"
                                        :error="errors.has('nombre corto')"
                                ...
                                <v-col md=6>
                                    <v-textarea
                                        v-model="nombreUsuario"
                                        outlined
                                        label="Resulados del aprendizaje"
                                ...
                                <v-col md=6>
                                    <v-textarea
                                        v-model="nombreUsuario"
                                        outlined
                                        label="Perfil del(a) participante"
                                        persistent-hint
                                        v-validate="'required|max:200'"
                                        data-vv-name="nombre corto"
                                        :error="errors.has('nombre corto')"
                                ...
                                <v-col md=12 style="text-align: center; background-color: #00b293; color: floralwhite;">
                                    <v-toolbar-title>Facilitadores(as)</v-toolbar-title>
                                </v-col>
