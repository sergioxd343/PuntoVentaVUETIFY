            ...
            beforeSend:function(){
                ...
                if(!$.isEmptyObject(data)){
                    ...
                    $.each(data,function (index, item) {    
                        ...
                        $select.append("<option  value='"+item.cve_convocatoria_admision+"'>"+item.descripcion +" </option>");
                    });
                ...
                if(!$.isEmptyObject(data)){
                   ...
                   // for(var i=0;i<100;i++){
                    tr_table+='<tr>'+
                        ...
                        "<td style='text-align: center'><button data-proceso='"+o.cve_proceso+"' data-id='"+o.cve_solicitud_admision+"' id='xbtnDocumentos"+o.cve_solicitud_admision+"' data-href='muestra_recepcion_documentos.jsp' name='xbtnDocumentos'  >Enlace</button></td>"+
          ...
          var id=$(this).attr("data-id");
             if(id>0){
                $.ajax({
                    ...
                    dataType:"JSON",
                    url:"Controller/procesoRevisionAdmisionController.jsp",
                    data:{yAccion:2,yCve_solicitud_admision:id,xUnidad:$("#xUnidadAcademica").val(),xConvocatoria:$("#xConvocatoria").val()},
                    beforeSend:function(){
						$("#loader").show();
                    },success:function(data){
                        var mes="",anio="";
