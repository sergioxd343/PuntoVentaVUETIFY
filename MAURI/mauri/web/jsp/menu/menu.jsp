<%@page contentType="text/html; charset=utf-8" language="java" errorPage="" %>
    ...
    <head>
        ...
        <style>
            ...
            .backgruond {
                background-image: linear-gradient(to right, #003b77, #005691, #0071ab, #0090c5, #00ace0, #00cbfb), url(../../images/1.2.jpg) !important;
    ...
    <body>
        <div id="app">
            <v-app>
                <v-card id="card" class="backgruond">
                    <v-row justify="center" class="align-center">
                                ...
                                <v-list shaped>
                                    <v-list-group v-for="menuNv1 in itemMenuSeleccionado" :key="menuNv1.cve_menu"
                                        ...
                                        <v-list-item v-if="menuNv1.submenu" v-for="menuNv2 in menuNv1.submenu"
                                            :key="menuNv2.cve_menu" link :href="menuNv2.ruta" target="iframe_modelo">
                                            <v-list-item-icon>
                        ...
                        <v-col md="9">
                            <iframe name="iframe_modelo" src="../../images/1.2.jpg"
                                style="border: none;" class="align-center"
