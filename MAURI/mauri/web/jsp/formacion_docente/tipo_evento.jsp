                    ...
                    <v-card>
                        ...
                        <v-container fluid>
                            ...
                            <v-row justify="center" class="align-center" style="padding: 0px 50px 0px 50px">
                                ...
                                <v-col md=2>
                                    <v-text-field 
                                        v-model="nombreTipoEvento" 
                                        outlined label="Nombre del evento" 
                                        persistent-hint
                                        v-validate="'required|max:200'" 
                                        data-vv-name="nombre tipo evento"
                            ...
                            <v-row justify="center">
                                <v-col md=12>
                                    <v-data-table
                                        :headers="headersTipoEvento"
                                        :items="dataTipoEvento"
                                        :search="searchTipos"
                                        class="elevation-2"
                                        no-data-text="No se encontro ningun registro"
                                        :hide-default-header="dataTipoEvento.length < 1"
                                        :hide-default-footer="dataTipoEvento.length < 1"
                                        locale="es-ES"
    ...
    <script type="module">
        ...
        new Vue({
            ...
            setup(){
                ...
                const ctr = "../controlador/formacion_docente/Controlador_tipo_evento.jsp";
                //Variables POST
               ...
               async function fnConsultarTablaTipoEvento(){
                ...
                return{
                    ...
                    fnGuardarTipoEvento, fnLimpiarCampos, fnEliminarEvento,
