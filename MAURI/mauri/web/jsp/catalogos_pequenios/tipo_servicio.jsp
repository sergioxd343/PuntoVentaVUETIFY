                ...
                <v-container fluid>
                    <v-card>
                        ...
                        <v-container fluid>
                            ...
                            </v-row><!-- Tabla tipo servicio -->
                            <v-row justify="center">
                                <v-col md=12>
                                    <v-data-table
                                        :headers="headersTipoServicio"
                                        :items="dataTipoServicio"
                                        :search="searchTipos"
                                        class="elevation-2"
                                        no-data-text="No se encontro ningun registro"
                                        :hide-default-header="dataTipoServicio.length < 1"
                                        :hide-default-footer="dataTipoServicio.length < 1"
                                        locale="es-ES"
    ...
    <script type="module">
        ...
        new Vue({
            ...
            setup(){
                ...
                const ctr = "../../controlador/catalogos_pequenios/Controlador_tipo_servicio.jsp";
                //Variables POST
                const nombreTipoServicio = ref("");
               ...
               async function fnConsultarTablaTipoServicio(){
                    try{
                        preloader("../../");
                ...
                async function fnGuardarTipoServicio(){
                    this.$validator.validate().then(async esValido => {
                        if(esValido){
                            try{
                                ...
                                parametros.append("nombre_tipo_servicio", nombreTipoServicio.value);
                ...
                async function fnCambiarEstatus(item) {
                        try {
                            ...
                            console.log("🚀 ~ file: tipo_servicio.jsp:283 ~ fnCambiarEstatus ~ parametros:", parametros)
                            let { data, status } = await axios.post(ctr, parametros);
                            if (status == 200) {
                                if (data == "1") {
                                    mostrarSnackbar(
                ...
                return{
                    ...
                    fnGuardarTipoServicio, fnLimpiarCampos, searchTipos, fnCambiarEstatus, currentUser,
                    currentUserObj, usuario_registro,
