               ...
               async function fnConsultarTablaTipoInstructor(){
                ...
                async function fnCambiarEstatus(item) {
                        try {
                            ...
                            console.log("🚀 ~ file: tipo_instructor.jsp:283 ~ fnCambiarEstatus ~ parametros:", parametros)
                            let { data, status } = await axios.post(ctr, parametros);
                            if (status == 200) {
                                if (data == "1") {
                                    mostrarSnackbar(
                ...
                return{
                    ...
                    fnConsultarTablaTipoInstructor, fnGuardarTipoInstructor, fnCambiarEstatus,
                    fnLimpiarCampos, currentUser, currentUserObj, usuario_registro,
