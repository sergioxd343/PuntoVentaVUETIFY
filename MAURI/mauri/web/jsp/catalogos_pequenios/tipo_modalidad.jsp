                            ...
                            <v-row justify="center" class="align-center" style="padding: 0px 50px 0px 50px">
                                <v-col md=4>
                                    <v-text-field 
                                        ...
                                        outlined label="Nombre tipo modalidad:" 
                                        persistent-hint
                                        hint="Ingresa el nombre del tipo de modalidad"
            ...
            setup(){
                ...
                async function fnCambiarEstatus(item) {
                        try {
                            ...
                            console.log("🚀 ~ file: tipo_modalidad.jsp:283 ~ fnCambiarEstatus ~ parametros:", parametros)
                            let { data, status } = await axios.post(ctr, parametros);
                            if (status == 200) {
                                if (data == "1") {
                                    mostrarSnackbar(
                ...
                return{
                    ...
                    fnGuardarTipoModalidad, searchTipos, fnLimpiarCamposModalidad, fnCambiarEstatus,
                    currentUser, currentUserObj, usuario_registro,
