                            ...
                            <v-row justify="center" class="align-center" style="padding: 0px 50px 0px 50px">
                                <v-col md=6>
                                    ...
                                    <v-text-field 
                                        ...
                                        outlined label="Nombre tipo capacitación:" 
                                        persistent-hint
                                        hint="Ingresa el nombre del tipo de capacitación"
        ...
        new Vue({
            ...
            setup(){
               ...
               async function fnConsultarTablaTipoCapacitacion(){
                    try{
                        ...
                        if(status == 200){
                            if(data.length > 0){
                                ...
                                dataTipoCapacitacion.value = data
                            }
                        }
                    } catch(error){
                ...
                async function fnGuardarTipoCapacitacion(){
