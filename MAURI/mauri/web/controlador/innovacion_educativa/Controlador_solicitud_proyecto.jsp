...
<%
    String xml= String.valueOf(request.getRealPath(""))+"\\model\\compras_requisiciones\\SolicitudProyecto.xml";
	...
	String sexo = request.getParameter("sexo") != null && !request.getParameter("sexo").equals("") ? request.getParameter("sexo") : "Otro";
