...
config. BalloonImgPath		= ((typeof wz_pathImg_ballon == "undefined")?"../../javascript/wz_tooltip/tip_balloon/":wz_pathImg_ballon); // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
...
function tt_inballon()
{
	document.write('<'+'script');
	document.write(' language="javascript"');
	document.write(' type="text/javascript"');
	document.write(' src="'+config.BalloonImgPath+'_utlSysballon.js">');
	document.write('</'+'script'+'>');
}
