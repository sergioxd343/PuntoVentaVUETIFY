...
window.history.go(1); 
	...
	function Recargar(cve_materia_frances) 
		{ 
			...
			document.forma.yCveMateriaPlanEstudioFrances.value = cve_materia_plan_estudio_frances; 
	...
	function Guardar() 
	  { 
		...
		if(document.forma.xControl.value==0)
		   	{
				alert("debe proporcionar un valor correcto"); 
   ...
   function Eliminar(cve_materia_plan_estudio_frances) 
	  	{ 
			if( confirm("Realmente desea Eliminar el registro")) 
					{ 
							document.forma.xCveMateriaPlanEstudioFrances.value = cve_materia_plan_estudio_frances; 
 				 
							document.forma.yResolucion.value = screen.width + "x" + screen.height; 
							document.forma.yAccion.value = "Eliminar"; 
							document.forma.submit(); 
					} 
	  	} 
    ...
    function RecargarPantalla() 
		{ 
			document.forma.yAccion.value = "RecargarPantalla";
			document.forma.submit(); 
		} 
