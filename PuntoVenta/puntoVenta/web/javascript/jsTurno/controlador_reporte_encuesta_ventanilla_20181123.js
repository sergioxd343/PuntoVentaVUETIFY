 ...
 */
ReporteEncuestaVentanilla.prototype.listarRespuestas = function (elemnt) {
...
//    let fecha_termino = $(reporteEncuestaVentanilla.cmbConvocatoria).find(":selected").attr("data-fecha-t");
    let cve_convocatoria = $(elemnt).val();
    let fecha_inicio = $(elemnt).find(":selected").attr("data-fecha-i");
    let fecha_termino = $(elemnt).find(":selected").attr("data-fecha-t");
