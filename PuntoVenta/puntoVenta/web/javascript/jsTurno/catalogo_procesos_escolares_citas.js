    ...
    "oLanguage": {
     ...
     "fnCreatedRow": function (row, data, index) {
        ...
        $(row).find(".edit").click(function () {
            ...
            $('.cazary-edit').contents().find('body').html(data["comentario"]);
     ...
     "aoColumns": [
        { "mData": "cve_cita_proceso_escolar","width": "2%" },
        { "mData": "nombre","width": "20%"},
         { "mData": "comentario","width": "15%"},
        { "mData": "activo",
...
catalogo_procesos_escolares_citas.prototype.fnCancelar=function(){
    $('#forma')[0].reset();
    $('.cazary-edit').contents().find('body').html("");
}
...
{
    var o=this;
    if( this.Nombre.val().length>0 ){
        
        $.ajax({
        type:"POST" ,
        dataType:"json",
        url:o.crt,
        data:{ yAccion: this.yAccion,yId:this.cve_cita_proceso_escolares,xNombre:this.Nombre.val(),xComentario:$("#edit").val(),yActivo:1},
        beforeSend:function(){
