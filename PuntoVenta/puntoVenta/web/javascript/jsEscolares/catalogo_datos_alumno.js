    ...
    "oLanguage": {
     ...
     "fnCreatedRow": function (row, data, index) {
        ...
        $(row).find(".edit").click(function () {
			window.scrollTo(0, 0);
            objCitasFechas.Proceso.val(data["id"]);
...
{
    var o=this;
    if( this.Inicio.size()>0 && this.Termino.size()>0 && this.Proceso.val()>0 ){
       o.cve_cita_proceso_escolares= this.Proceso.val()
        ...
        dataType:"json",
        url:o.crt,
        data:{ yAccion: this.yAccion,yId:this.cve_cita_fecha_atencion,xProcesoEscolar:this.cve_cita_proceso_escolares,xFechaInicio:this.Inicio.val(),xFechaTermino:this.Termino.val(),yActivo:1},
        beforeSend:function(){
